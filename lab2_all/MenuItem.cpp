...
std::string MenuItem::getTaxCategory() const {
    return taxCategory;
}
...
void MenuItem::setBasePrice(double newPrice) {
    basePrice = newPrice;
}
...
void MenuItem::setCostPrice(double newCost) {
    costPrice = newCost;
}

void MenuItem::setTaxCategory(const std::string& newTaxCategory) {
